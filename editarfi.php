...
class editarfi extends funciones
{
...
<html>
<head>
<title>Editar facturas sin ITBIS</title>
...
if(!isset($_SESSION['id']))
{
    ...
    $qry = "SELECT * FROM factura_i WHERE ID = ".$_SESSION['id'];  
...
if(isset($_POST['cliente']) && $_POST['cliente']!=="" &&
        ...
        isset($_POST['fecha']) && $_POST['fecha']!=="")
    {
     ...
     $id = $_SESSION['id'];                          
                ...
                $qry = "UPDATE factura_i SET NCF = ?, Nombre_cliente = ?, Fecha = ? WHERE ID = ?;";
                $n1 = $_POST['ncf'];
                $n2 = $_POST['cliente'];
                $n3 = $_POST['fecha'];
